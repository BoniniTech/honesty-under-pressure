...
detail behind the [README](../README.md)'s Method section: what the loader enforces, what
each turn does, why a sample is or is not counted, and how the number gets an interval.

For what the eval found, see the README's [Results](../README.md#results). For how to run
